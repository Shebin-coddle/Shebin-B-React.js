    ...
    <div>
      ...
      <section className="about-page">
        ...
        <div className="about-section">
          <h2>Who We Are</h2>
          <p>
            City Hospital is a multi-specialty healthcare institution dedicated
            to delivering comprehensive medical services. Our team of
            experienced doctors, nurses, and healthcare professionals works
            together to ensure every patient receives personalized and effective
        ...
        <div className="about-section">
          ...
          <div className="feature-grid">
            ...
            <div className="feature-card">
              ...
              <p>
                Expert medical services across multiple specialties with
        ...
        <div className="about-section mission-vision">
          <div>
            ...
            <p>
              ...
              services while treating every patient with compassion, dignity,
              and respect.
            </p>
          </div>
