  ...
  return (
    <section className="hero" id="home">
      <div className="hero-content">
        ...
        <p>
          Experienced doctors, advanced medical facilities,
          and compassionate care for you and your family.
          Book appointments online and receive quality
          healthcare anytime.
        </p>

        <div className="hero-buttons">
          <button className="primary-btn" onClick={()=> HandleBookAppointments(navigate,Number(localStorage.getItem("role_id")))}>
            Book Appointment
          </button>
